...
- 学生ハンドブックは四半期ごとに見直され、必要に応じて通常の MOC リリース チャネルを通じて更新されます。
...
MCT とパートナーは、これらの資料にアクセスし、学生に個別に提供すること強く推奨します。  進行中のクラスの一部としてラボ ステップにアクセスできるように、学生に直接 GitHub を指示するには、学生がコースの一部として別の UI にもアクセスする必要がありますが、これは混乱の原因となります。 なぜ個別のラボの手順を受け取るのかについて学生に説明する場合、クラウドベースのインターフェイスとプラットフォームが常に変化しているという性質を強調できます。 GitHub 上のファイルにアクセスするための Microsoft Learning サポートと GitHub サイトのナビゲーションのサポートは、このコースを教える MCT のみに限定されています。
