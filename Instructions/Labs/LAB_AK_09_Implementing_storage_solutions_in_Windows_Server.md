...
1. 必要に応じて、**[この接続に別のアカウントを使用する]** オプションが選択されていることを確認し、講師から提供された資格情報を入力してから、**[資格情報を使用して追加する]** を選択します。

1. **sea-svr3.contoso.com** ページの**ツール**メニューで **PowerShell** を選択してから、メッセージが表示されたら、講師から提供された資格情報でサインインします。
...
1. **[この接続に別のアカウントを使用する]** オプションが選択されていることを確認し、講師から提供された資格情報を入力してから、**[アカウントを使用して接続する]** を選択します。
